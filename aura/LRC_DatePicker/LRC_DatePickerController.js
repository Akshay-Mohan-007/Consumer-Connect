({
  doInit: function(component, event, helper) {
    ...
    var langLocale = $A.get("$Locale.langLocale");
      ...
      console.log("langLocale is:"+langLocale);
...
//Hariharan[US-14248] Method to show the date picker on click of a button
 ...
 //Sayari -- to show time picker//
    ...
    checkTimeValidity:function(component,event,helper){
        helper.checkTimeValidity(component,event);
    },
  ...
  handleClick: function(component, event, helper) {
    ...
    if (grid) {
      ...
      console.log("on click of cell:"+component.get("v.value"));
  ...
  handleClearDate: function(component, event, helper) {
    ...
    var grid2 = component.find("grid2");
         if(grid2){
              $A.util.addClass(grid2, 'slds-hide');
              $A.util.addClass(grid2, 'slds-transition-hide');
              component.set("v.isTimepickerOpen", false);  
         }
    var grid1 = component.find('grid');
    if (grid1) {
      $A.util.addClass(grid1, "slds-hide");
		component.set("v.isDatepickerOpen", false);       
