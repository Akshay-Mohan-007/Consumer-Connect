({
    ...
    saveAndChangeTab : function(component, event, helper) {
        ...
        var bIsValid = helper.saveTab(component);
    ...
    back : function(component, event, helper) {
        helper.backTab(component,helper.saveTab(component));
    },
    save : function(component, event, helper) {
        helper.saveTab(component);
        helper.redirectToHomePage(component);
    },
    next : function(component, event, helper) {
        helper.nextTab(component,helper.saveTab(component));
    },
