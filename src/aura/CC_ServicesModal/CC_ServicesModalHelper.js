({
	validate : function(component,event) {
		...
		if($A.util.isEmpty(component.get("v.selectedService")) ) {
            ...
            lstError.push(mapLabels.CC_Label_Please+' '+mapLabels.CC_Label_Select_Service);
		...
		if(!$A.util.isEmpty(component.get("v.selectedService")) 
			...
			lstError.push(mapLabels.CC_Label_Please+' '+mapLabels.CC_Label_Enter_Service_Name);
		...
		if(component.get("v.bCurrentlyGetting") && $A.util.isEmpty(component.get("v.selectedProgram")) ) {
			...
			lstError.push(mapLabels.CC_Label_Please+' '+mapLabels.CC_Label_Select_Prog);
		}
		...
		if(!$A.util.isEmpty(component.get("v.selectedProgram")) 
			...
			lstError.push(mapLabels.CC_Label_Please+' '+mapLabels.CC_Label_Enter_Prog);
		}
