({
    ...
    setLeftNav : function(component,mapLabels) {
        var lstTabs = [
            {
                label: mapLabels.CC_Contact_Information,
                name: "CC_ContactInformation"
            },
            {
                label: mapLabels.CC_Representative_Information,
                name: "CC_RI_Infro"
            },
            {
            ...
            {
                label: mapLabels.CC_Summary      ,
                name: "CC_ApplicationSummaryComponent"
            }
        ];
    ...
    submit : function(component,helper){
        ...
        childComp.submit(function(lstNotVisitedTabs){
            if(!$A.util.isEmpty(lstNotVisitedTabs)){//checks if any page to redirect to before submission
                ...
                this.showToast('Success', component.get('v.mapLabels').Submit_Success, 'success', 'sticky', 5000);
